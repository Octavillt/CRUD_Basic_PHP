							...
							if(!empty($result_query)){
								...
								while($row = mysqli_fetch_array($sql_query)){
									...
									<tr>
										...
										<td><?= $row['email']; ?></td>
										<td>
											<a class="btn btn-warning btn-sm" href="actualizar_usuario.php?id=<?=$row['id_persona']; ?>"><i class="fas fa-user-edit fa-xs"></i></a>
											<a class="btn btn-danger btn-sm" href="eliminar_usuario.php?id=<?= $row['id_persona']; ?>"><i class="fas fa-user-minus fa-sm"></i></a>
										</td>
									</tr>
									<?php  
								}
